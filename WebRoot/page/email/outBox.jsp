...
<form class="am-form am-form-inline" role="form">
	...
	<div class="am-form-group am-form-select am-u-sm-2">
  	...
  	<a class="am-btn am-btn-warning am-btn-sm" href="javascript:link('${pageContext.request.contextPath}/page/email/queryOutBox.do?classify='+$('#classify').val()+'&keyword='+$('#keyword').val());">
