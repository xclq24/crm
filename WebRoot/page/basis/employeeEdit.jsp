...
<form class="am-form am-form-horizontal" method="post">
	...
	<div class="am-form-group">
		...
		<div class="am-u-sm-4">
			<input class="am-form-field am-input-sm" type="text" name="user.addtime" value='<fmt:formatDate value="${user.addtime }" type="date" pattern="yyyy-MM-dd hh:mm:ss"/>' disabled="disabled">
		</div>
	</div>
	<div class="am-form-group">
	...
	<div class="am-form-group">
		<div class="am-u-sm-10 am-u-sm-offset-2">
			<button type="button" class="am-btn am-btn-primary" onclick="javascript:haha('${pageContext.request.contextPath}/page/basis/modifyEmployee.do');">
				确认
			</button>
